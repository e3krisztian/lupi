...
[**complete_round**](GameApi.md#complete_round) | **PUT** /rounds/{round}/is_completed | 
...
# **complete_round**
> complete_round(round, body=body)
...
body = True # bool |  (optional)
    ...
    try:
        api_instance.complete_round(round, body=body)
    except ApiException as e:
        print("Exception when calling GameApi->complete_round: %s\n" % e)
```
